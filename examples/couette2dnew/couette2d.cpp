...
int main() {
  ...
  vtmwriter::ScalarWriter ShearRateWriter("ShearRate", NSLattice.getField<StrainRateMag<T>>());
  vtmwriter::vtmWriter<T, LatSet::d> NSWriter("couette2d", Geo);
  NSWriter.addWriterSet(RhoWriter, VecWriter, ShearRateWriter);
